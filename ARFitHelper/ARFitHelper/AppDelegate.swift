...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func addFewExercises() {
           ...
           ref.child("pulling-up").setValue(["exercisename": "pulling-up", "kind": "basic", "targetingMusclesGroup": "chest and back", "synergistsMusclesGroup": "-", "technic": "try to touch the bar with your chin", "videoURL": "https://youtu.be/fEC6rPFPUrY"])
